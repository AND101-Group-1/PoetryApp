...
**An app that allows user to discover their new favorite poems. Each day a new poem will be show to the user.**
...
- User will see a new poem daily 
- User can find poems with the title
- User can see poems based on a genre
- USer can find poems from a specific author
